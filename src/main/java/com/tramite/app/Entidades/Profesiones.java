...
public class Profesiones  implements Serializable {
	...
	public Long getNIDPROFESIONPK() {
		return NIDPROFESIONPK;
	}


	public void setNIDPROFESIONPK(Long nIDPROFESIONPK) {
		NIDPROFESIONPK = nIDPROFESIONPK;
	}
