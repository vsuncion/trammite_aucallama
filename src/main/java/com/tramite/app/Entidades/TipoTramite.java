...
public class TipoTramite  implements Serializable{
	...
	private Long IDTIPOTRAMITEPK;
	
	@NotEmpty(message = "EL CAMPO NOMBRE TIPO DE TRAMITE, ES OBLIGATORIO") 
	...
	public Long getIDTIPOTRAMITEPK() {
		return IDTIPOTRAMITEPK;
	}



	public void setIDTIPOTRAMITEPK(Long iDTIPOTRAMITEPK) {
		IDTIPOTRAMITEPK = iDTIPOTRAMITEPK;
	}
